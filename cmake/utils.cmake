macro(clone_and_build_external_project EXTERNAL_DIR REPO REPO_URL REPO_TAG)
  add_custom_command(
    OUTPUT ${EXTERNAL_DIR}/${REPO}/CMakeLists.txt # Dummy file to indicate that the repo has been cloned.
    COMMAND ${CMAKE_COMMAND} -E rm -rf ${EXTERNAL_DIR}/${REPO}
    COMMAND ${CMAKE_COMMAND} -E make_directory ${EXTERNAL_DIR}/${REPO}
    COMMAND git clone --recurse-submodules --branch ${REPO_TAG} ${REPO_URL} ${EXTERNAL_DIR}/${REPO}
    COMMENT "Cloning external repository..."
    VERBATIM
  )

  add_custom_command(
    OUTPUT ${EXTERNAL_DIR}/${REPO}/built_library
...
function(define_gpu_extension_target GPU_MOD_NAME)
  ...
  target_link_libraries(${GPU_MOD_NAME} PRIVATE ${GPU_LIBRARIES})
