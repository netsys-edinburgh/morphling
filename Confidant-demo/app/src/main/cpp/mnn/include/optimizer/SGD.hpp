...
public:
    ...
    // added by CYH
    std::vector<Express::VARP> backward(Express::VARP loss, Express::VARP input, Express::VARP lossGrad, std::map<Express::VARP, Express::VARP>& grads);
    void updateParameters(std::map<Express::VARP, Express::VARP>& grads) override;
protected:
