...
// }
        ...
        public:
            ...
            // added by cyh
            static void prepareComputeParallel(const std::vector<VARP>& vars, bool isMultipleBackend = false, std::vector<std::pair<MNNForwardType, int>> types = {});
            static void prepareComputeByForwardType(const std::vector<VARP>& vars, bool forceCPU = false, std::pair<MNNForwardType, int> types = {MNN_FORWARD_CPU, 1});
