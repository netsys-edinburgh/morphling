...
int main() {
  ...
  // allocate cuda memory
    ...
    cudaMemcpyAsync(cuda_ptr1, src1.data(), MEM_SIZE, cudaMemcpyHostToDevice, stream1);
    cudaMemcpyAsync(cuda_ptr2, src2.data(), MEM_SIZE, cudaMemcpyHostToDevice, stream2);
    ...
    // convert to GB/s
    std::cout << "Bandwidth: " << MEM_SIZE * 2 / 1e9 / elapsed.count() << " GB/s\n";
